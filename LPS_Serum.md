...
## Plot data
![](LPS_Serum_files/figure-html/unnamed-chunk-3-1.png)<!-- -->
...
```
## normality of log2 transformed data
```
...
## Plot data
![](LPS_Serum_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
