...
---
This is an rmarkdown of the ephys data from **CON:CON**, **CON:PLX**, **MIA:CON**, and **MIA:PLX** mice treated with 10 mg/kg PIC at E9 and PLX from E9-E12. Recordings were performed on D1TdTom- or Drd2-Cre; RCE+ cells in the ventral striatum.
...
cumlFreq <- read.csv("2110816_rescue_mEPSC_cumprob.csv", stringsAsFactors = T)
